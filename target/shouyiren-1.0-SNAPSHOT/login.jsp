    ...
    <div class="container">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="tel" required  lay-verify="required" placeholder="请输入用户名" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <label class="layui-form-label" style="text-align: left">12</label>
            <!-- <div class="layui-form-mid layui-word-aux">辅助文字</div> -->
