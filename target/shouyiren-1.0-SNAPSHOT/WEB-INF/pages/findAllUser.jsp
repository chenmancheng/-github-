...
<div class="table-wrapper">
    ...
    <%
        List<User> v =(List<User>)request.getAttribute("allUser");
    ...
    <tr onmouseover="this.style.backgroundColor='#D7FFF0';"onmouseout="this.style.backgroundColor='#FFFFFF';" >
        ...
        <td width=100px><%=bean.getTel()%></td>
        <td width=100px><%=bean.getPassword()%></td>
        <td width=100px><%=bean.getName()%></td>
        <td width=100px><%=bean.getGender()%></td>
        <td width=100px><%=bean.getAge()%></td>
        <td width=100px><%=bean.getQuestion()%></td>
        <td width=100px><%=bean.getAnswer()%></td>
        <td width=100px><%=bean.getHeadportrait()%></td>
        <td width=100px><%=bean.getAddress()%></td>
        <td style="width:30%">
<%--            <a href="admin/goToUpdateProduct?name=<%=bean.getTel()%>">&nbsp;&nbsp;&nbsp;修改&nbsp;&nbsp;&nbsp;&nbsp;</a>--%>
            <a href="admin/deleteUser?id=<%=bean.getId()%>"
